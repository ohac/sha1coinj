...
import com.google.sha1coin.core.TransactionConfidence.ConfidenceType;
import com.google.sha1coin.crypto.DeterministicKey;
import com.google.sha1coin.crypto.KeyCrypter;
import com.google.sha1coin.crypto.KeyCrypterException;
import com.google.sha1coin.crypto.KeyCrypterScrypt;
...
import com.google.sha1coin.store.UnreadableWalletException;
import com.google.sha1coin.store.WalletProtobufSerializer;
import com.google.sha1coin.utils.BaseTaggableObject;
import com.google.sha1coin.utils.ListenerRegistration;
import com.google.sha1coin.utils.Threading;
import com.google.sha1coin.wallet.*;
import com.google.sha1coin.wallet.WalletTransaction.Pool;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.sha1coin.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag {
     ...
     * {@link com.google.sha1coin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.google.sha1coin.wallet.KeyChain.KeyPurpose)} with
     * {@link com.google.sha1coin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.google.sha1coin.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.google.sha1coin.wallet.KeyChain.KeyPurpose)} with
     * {@link com.google.sha1coin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.google.sha1coin.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.google.sha1coin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.google.sha1coin.wallet.KeyChain.KeyPurpose)} with
     * {@link com.google.sha1coin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.google.sha1coin.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.google.sha1coin.wallet.KeyChain.KeyPurpose)} with
     * {@link com.google.sha1coin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.sha1coin.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.google.sha1coin.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.google.sha1coin.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.google.sha1coin.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.google.sha1coin.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.sha1coin.crypto.KeyCrypter,
     ...
     * {@link com.google.sha1coin.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link com.google.sha1coin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.google.sha1coin.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.sha1coin.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link com.google.sha1coin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.sha1coin.core.TransactionBroadcaster broadcaster) {
     ...
     * {@link com.google.sha1coin.core.PeerFilterProvider} interface and generally should not be used directly by apps.
