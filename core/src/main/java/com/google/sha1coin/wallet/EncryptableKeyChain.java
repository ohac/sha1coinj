...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(com.google.sha1coin.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link com.google.sha1coin.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link com.google.sha1coin.core.Wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
