...
import com.google.sha1coin.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link com.google.sha1coin.core.Transaction#getConfidence()}. It's safe to modify the
