...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link com.google.sha1coin.core.Wallet}. Key chains
...
public interface KeyChain extends KeyBag {
     ...
     *
     * <p>See the docs for {@link com.google.sha1coin.core.BloomFilter#BloomFilter(int, double, long)} for a brief
