 ...
 * the lightweight SPV mode, a {@link com.google.sha1coin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.sha1coin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
