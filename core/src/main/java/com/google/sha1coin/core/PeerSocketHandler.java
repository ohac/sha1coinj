...
import com.google.sha1coin.net.AbstractTimeoutHandler;
import com.google.sha1coin.net.MessageWriteTarget;
import com.google.sha1coin.net.StreamParser;
 ...
 * {@link com.google.sha1coin.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.google.sha1coin.net.NioClient} or
     * {@link com.google.sha1coin.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
