...
public interface BlockChainListener {
     ...
     * us via either {@link #receiveFromBlock(Transaction, StoredBlock, com.google.sha1coin.core.BlockChain.NewBlockType, int)}
     * or {@link #notifyTransactionIsInBlock(Sha256Hash, StoredBlock, com.google.sha1coin.core.BlockChain.NewBlockType, int)}.
