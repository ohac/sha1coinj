package com.google.sha1coin.net;

import com.google.sha1coin.core.BloomFilter;
import com.google.sha1coin.core.PeerFilterProvider;
...
/**
 * <p>A reusable object that will calculate, given a list of {@link com.google.sha1coin.core.PeerFilterProvider}s, a merged
 * {@link com.google.sha1coin.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link com.google.sha1coin.core.PeerGroup} class internally.</p>
 *
