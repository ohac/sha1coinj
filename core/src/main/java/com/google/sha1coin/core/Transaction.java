...
import com.google.sha1coin.wallet.DecryptingKeyBag;
import com.google.sha1coin.wallet.KeyBag;
...
import static com.google.sha1coin.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.sha1coin.script.Script, ECKey, com.google.sha1coin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.sha1coin.core.Transaction.SigHash, boolean)}
