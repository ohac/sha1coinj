 ...
 * {@link com.google.sha1coin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.sha1coin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.google.sha1coin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.sha1coin.net.StreamParser)}
     * or
     * {@link com.google.sha1coin.net.NioClient#NioClient(java.net.SocketAddress, com.google.sha1coin.net.StreamParser, int)}.</p>
     *
   ...
   /**
     ...
     * Once the pong is received the value returned by {@link com.google.sha1coin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.sha1coin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.sha1coin.core.Peer#ping()} has never
