...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.sha1coin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.sha1coin.core.BlockChain#getBestChainHeight()} which will run in constant time and
