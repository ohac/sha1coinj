...
import com.google.sha1coin.core.BloomFilter;
import com.google.sha1coin.core.ECKey;
import com.google.sha1coin.core.Utils;
import com.google.sha1coin.crypto.*;
 ...
 * {@link com.google.sha1coin.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.google.sha1coin.crypto.MnemonicCode},
 ...
 * {@link com.google.sha1coin.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.google.sha1coin.crypto.DeterministicKey#deserializeB58(com.google.sha1coin.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.google.sha1coin.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.google.sha1coin.crypto.DeterministicHierarchy} and
 * {@link com.google.sha1coin.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.google.sha1coin.crypto.DeterministicKey)}
