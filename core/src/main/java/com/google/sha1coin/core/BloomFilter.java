...
public class BloomFilter extends Message {
     ...
     * See {@link com.google.sha1coin.core.BloomFilter.BloomUpdate} for a brief description of each mode. The purpose
    ...
    /**
     * Returns true if this filter will match anything. See {@link com.google.sha1coin.core.BloomFilter#setMatchAll()}
