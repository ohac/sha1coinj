...
import com.google.sha1coin.core.*;
import com.google.sha1coin.crypto.ChildNumber;
...
/**
 * <p>A KeyChainGroup is used by the {@link com.google.sha1coin.core.Wallet} and
 * manages: a {@link com.google.sha1coin.wallet.BasicKeyChain} object (which will normally be empty), and zero or more
 * {@link com.google.sha1coin.wallet.DeterministicKeyChain}s. A deterministic key chain will be created lazily/on demand
 ...
 * class docs for {@link com.google.sha1coin.wallet.DeterministicKeyChain} for more information on this topic.</p>
 */
public class KeyChainGroup {
     ...
     * For married keychains use {@link #currentAddress(com.google.sha1coin.wallet.KeyChain.KeyPurpose)}
     ...
     * <p>This method is not supposed to be used for married keychains and will throw UnsupportedOperationException if
     * the active chain is married.
     * For married keychains use {@link #freshAddress(com.google.sha1coin.wallet.KeyChain.KeyPurpose)}
     * to get a proper P2SH address</p>
     */
     ...
     * see {@link com.google.sha1coin.wallet.DeterministicKeyChain#setLookaheadSize(int)}
     ...
     * {@link com.google.sha1coin.wallet.DeterministicKeyChain#setLookaheadSize(int)}
     * for more information.
     */
     ...
     * {@link com.google.sha1coin.wallet.DeterministicKeyChain#setLookaheadThreshold(int)}
     * for more information.
     */
     ...
     *
     * @throws com.google.sha1coin.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.google.sha1coin.crypto.KeyCrypterScrypt}.
     *
     * @throws com.google.sha1coin.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
     ...
     * @throws com.google.sha1coin.wallet.DeterministicUpgradeRequiresPassword if the key chain group is encrypted
