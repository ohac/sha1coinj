...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws com.google.sha1coin.store.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws com.google.sha1coin.store.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(com.google.sha1coin.crypto.KeyCrypter,
