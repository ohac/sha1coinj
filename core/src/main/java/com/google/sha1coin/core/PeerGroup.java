...
import com.google.sha1coin.crypto.DRMWorkaround;
import com.google.sha1coin.net.BlockingClientManager;
import com.google.sha1coin.net.ClientConnectionManager;
import com.google.sha1coin.net.FilterMerger;
import com.google.sha1coin.net.NioClientManager;
import com.google.sha1coin.net.discovery.PeerDiscovery;
import com.google.sha1coin.net.discovery.PeerDiscoveryException;
import com.google.sha1coin.net.discovery.TorDiscovery;
import com.google.sha1coin.script.Script;
import com.google.sha1coin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.sha1coin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.sha1coin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.sha1coin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.sha1coin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.sha1coin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.sha1coin.core.Peer#ping()}.
     */
